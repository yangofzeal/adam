...
if __name__ == "__main__":
    print_environment("HKD_ADAM_LARGE_RELEASE_TEST")

    if IS_FREE:
        print("mode=free_limit_verification")
        print("large_benchmark=SKIPPED_FREE_EDITION")
        print()
        verify_free_limit()
        print("PASS=True")
    else:
        print("mode=unlimited_asymptotic")
        print()
        run_sweep([
            25000,
            100000,
